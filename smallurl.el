...
(defvar smallurl-service 'vgd
  "The service to use. One of `smallurl-services-map'.")

(defvar smallurl-services-map
  '((tinyurl . "http://tinyurl.com/api-create.php?url=") ; no longer works?
    (trim    . "http://api.tr.im/api/trim_simple?url=")	; no longer works?
    (untiny  . "http://untiny.me/api/1.0/extract?format=text&url=")
    (vgd     . "http://v.gd/create.php?format=simple&logstats=1&url="))
